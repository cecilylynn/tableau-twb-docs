...
def build_caption(lines):
    ...
    ft.append(_br())
    ft.append(_run("Documentation generated using the tableau-twb-docs skill, created by Cecily Santiago (github.com/cecilylynn).",
...
def add_developer_notes(root, ds_name):
    ...
    add_line("or identify if changes have been made by comparing it to the caption.",
             fontsize="14", fontcolor="#027b8e")
    add_line("")
    add_line("Documentation generated using the tableau-twb-docs skill, created by Cecily Santiago (github.com/cecilylynn).",
