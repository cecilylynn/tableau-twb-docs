...
| **COLUMNS** | `table > cols` text | Resolve field names, include aggregation |
...
- `#787878` — attribution ("Documentation generated by GitHub Copilot")
- `#d80937` — warnings
...
Documentation generated by GitHub Copilot based on dashboard FAQ and workbook structure. [italic, gray]
```
